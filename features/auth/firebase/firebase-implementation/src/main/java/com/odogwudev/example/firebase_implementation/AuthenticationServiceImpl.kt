package com.odogwudev.example.firebase_implementation
...
import com.odogwudev.example.firebase_api.*
...
class AuthenticationServiceImpl(private val activityProvider: ActivityProvider) :
    ...
    override fun initialize(context: Context) {
        ...
        _authenticationState.value =
            if (firebaseAuth.currentUser == null) AuthenticationState.NotLogged else AuthenticationState.Logged
    }
    ...
    override fun loginWithFacebookAccount(): Flow<AuthResult> =
        callbackFlow<AuthWithResult<String>> {
            ...
            when (result) {
                is AuthWithResult.Success -> {
                    consumeTask(
                        task = firebaseAuth.signInWithCredential(
    ...
    companion object {
        private const val WEB_CLIENT_ID: String =
            "247527369279-pietmih15tgv32h2ug2jng82n3phpchg.apps.googleusercontent.com"
    }
}
